...
/**
 * Class FeatureRequestModel_Migration
 */
class FeatureRequestModel_Migration {
    ...
    public function up()
    {
        $this->database = new Asatru\Database\Migration('FeatureRequestModel', $this->connection);
        $this->database->drop();
        ...
        $this->database->add('status VARCHAR(32) NOT NULL DEFAULT \'open\'');
