...
class PlantsModel_Migration {
    ...
    public function up()
    {
        $this->database = new Asatru\Database\Migration('PlantsModel', $this->connection);
        $this->database->drop();
        ...
        $this->database->add('harvest_tracking_enabled BOOLEAN NOT NULL DEFAULT 0');
        ...
        $this->database->add('parent_plant INT NULL');
