...
class UserModel_Migration {
    ...
    public function up()
    {
        $this->database = new Asatru\Database\Migration('UserModel', $this->connection);
        $this->database->drop();
        ...
        $this->database->add('notify_plant_care BOOLEAN NOT NULL DEFAULT 1');
        $this->database->add('push_tasks_overdue BOOLEAN NOT NULL DEFAULT 1');
        $this->database->add('push_tasks_tomorrow BOOLEAN NOT NULL DEFAULT 1');
